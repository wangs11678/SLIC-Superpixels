 ...
 * Output: -
 */
void Slic::display_rect_box(IplImage *image, CvScalar colour) {
	for (int i = 0; i < (int) centers.size(); i++) {
        cvRectangle(image, cvPoint(centers[i][3]-40, centers[i][4]-40), cvPoint(centers[i][3]+40, centers[i][4]+40), colour, 1, 4, 0);
    }
}
